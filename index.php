                ...
                <div class="heading__inner">
                    <div class="heading__box">
                        ...
                        <div class="heading__wrapper">
                            <a href="#" class="heading__btn btn">Заказать</a>
                        </div>
                    ...
                    <div class="catalog__wrapper tabs__wrapper-menu--open">
                        <div class="catalog-menu__content">
                            <div class="catalog-menu__item">
                                <a href="#" class="catalog-menu__item-img">
                                    <img src="./img/tabs-img.png" alt="img">
                                </a>
                                <p class="catalog-menu__item-wrapper">
                                    <a href="#" class="catalog-menu__item-title">Холодные закуски</a>
                                </p>
                                <p class="catalog-menu__btn-wrapper">
                                    <a href="#" class="catalog-menu__item-btn">К блюдам</a>
                                </p> 
                            </div>
                            <div class="catalog-menu__item">
                                <a href="#" class="catalog-menu__item-img">
                    ...
                    <div class="tabs__wrapper tabs__wrapper-dilivery--open">
                        <div class="tabs-delivery__box">
                            ...
                            <div class="tabs-delivery__content">
                                ...
                                <div class="heading__wrapper">
                                    <a href="#" class="tabs-delivery__content-btn btn">Перейти в меню</a>
                                </div>
